...
a='<div><span style="color:#FF0000;">出现人员同步的问题,请及时排查问题!</strong></span></div>'
a1=a.encode('gbk')
print(a1)
data = {'TO_UID':'960','TO_NAME':'','TD_HTML_EDITOR_CONTENT':a1,'I_VER':'2','C':'web','ACTION_TYPE':'sms'}
...
# print(url,type(url))
 ...
 # print(data1)
 # print(data)
requests.post( r'http://192.168.0.101/general/status_bar/sms_send.php', headers=headers,data=data)

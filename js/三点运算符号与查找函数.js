...
const vy = number.findIndex((item) => {
    return item > 25 //类似 python 的列表推导式 a=[a for a in number a>25]
})
...
var arr2 = [...arr1, 7]
arr2 // ['hello']
console.log("arr1.length", arr1.length, arr1[3], arr1 == arr2)
console.log("arr2.length", arr2.length, arr2[3], arr1 == arr2)
